...
import { SiReact,  SiTypescript, SiTailwindcss, SiJavascript, SiPython, SiHtml5, SiCss3,  SiMongodb,  } from 'react-icons/si';
...
const backendLogos = [
  ...
  { node: <DiJava className="text-[#007396]" />, title: "Java", href: "https://www.java.com" }, 
      ...
      <div className="container mx-auto px-6 lg:px-12 py-20 relative z-10">
        ...
        <div className="text-center mb-16 opacity-0 animate-[fadeInUp_1s_ease-out_0.2s_forwards]">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light">
            Explore the technologies I use to build modern, scalable applications
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="opacity-0 animate-[fadeInLeft_1s_ease-out_0.4s_forwards]">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50 transition-all duration-300 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/10 h-full">
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-4xl">💻</span>
                  <h2 className="text-3xl font-bold text-white">Frontend Development</h2>
                </div>
              ...
              <div className="bg-gray-900/50 rounded-2xl p-6 border border-gray-700/30">
                <LogoLoop
                  ...
                  scaleOnHover
                  fadeOut
                  fadeOutColor="rgb(17 24 39)"
                  className="[--logoloop-fadeColorAuto:rgb(17_24_39)]"
          ...
          <div className="opacity-0 animate-[fadeInRight_1s_ease-out_0.6s_forwards]">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50 transition-all duration-300 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/10 h-full">
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-4xl">⚙️</span>
                  <h2 className="text-3xl font-bold text-white">Backend Development</h2>
                </div>
                <p className="text-gray-400 text-lg font-light">
