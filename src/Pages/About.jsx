...
const About = () => {
  ...
  /* Open GitHub when "View My Work" is clicked */
  const onViewWork = () =>
    window.open('https://github.com/rutuja-85860', '_blank', 'noopener,noreferrer');
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      ...
      <div ref={containerRef} className="container mx-auto px-6 lg:px-12 pt-28 pb-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={textBlockRef} className="space-y-10">
            ...
            <motion.div ref={ctaRef}>
              <motion.button
                onClick={onViewWork}
                className="group relative px-10 py-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg rounded-2xl shadow-2xl hover:shadow-blue-500/50 transition-all duration-500 overflow-hidden border-0 cursor-pointer"
                whileHover={{
                  scale: 1.05,
